...
//        @V("statisticsContent") String statisticsContent,
//        @V("releasesContent") String releasesContent,
//        @V("referencesContent") String referencesContent,
        @V("codeSampleContent") String codeSampleContent,
        @V("version") String langchain4jVersion
    );
